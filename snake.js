...
function changeDirection(event) {
    if (event.code == "ArrowUp" && velocityY != 0.5) {
        velocityX = 0;
        velocityY = -0.5;
    } else if (event.code == "ArrowDown" && velocityY != -0.5) {
        velocityX = 0;
        velocityY = 0.5;
    } else if (event.code == "ArrowLeft" && velocityX != 0.5) {
        velocityX = -0.5;
        velocityY = 0;
    } else if (event.code == "ArrowRight" && velocityX != -0.5) {
        velocityX = 0.5;
        velocityY = 0;
    }
}
